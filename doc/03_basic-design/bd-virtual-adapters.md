...
本書は `doc/specs/spec-virtual-vcs.md` の第1節 (1.1, 1.2), 第2節, 第3節 (3.1, 3.2, 3.3), 第6節および `doc/01_architecture/sfvcs-design.md` の仕様を完全網羅し、カプセル化された Virtual VCS Layer モジュールとして詳細を定義する。
