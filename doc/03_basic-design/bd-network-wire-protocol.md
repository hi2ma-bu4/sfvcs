...
本書は `doc/specs/spec-network.md` の第1節, 第2節 (2.1, 2.2, 2.3) および `doc/01_architecture/sfvcs-design.md` のネットワーク通信仕様を完全網羅し、カプセル化された Network Protocol Codec Layer モジュールとして詳細を定義する。
