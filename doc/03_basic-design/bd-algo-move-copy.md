...
本書は `doc/specs/spec-algorithms.md` の第5節 (5.1, 5.2), 第6節 (6.1, 6.2, 6.3) および `doc/01_architecture/sfvcs-design.md` の第167.8, 171.14節の仕様を完全網羅し、カプセル化された Move Detection Service モジュールとして詳細設計を定義する。
