...
本書は `doc/specs/spec-algorithms.md` の第9節 (9.1), 第10節 (10.1), 第18節 (18.1) および `doc/01_architecture/sfvcs-design.md` の第171.1, 171.14節の仕様を完全網羅し、カプセル化された History Mining Service モジュールとして定義する。
