...
本書は `doc/specs/spec-storage.md` の第10節 (10.1, 10.2), 第17節 (17.1), 第20節 (20.1) および `doc/01_architecture/sfvcs-design.md` の第171.2, 171.9, 171.14節の仕様を完全網羅し、カプセル化された Acceleration & File Watching Service モジュールとして詳細を定義する。
