...
本書は `doc/specs/spec-virtual-vcs.md` の第7節 (7.1), 第10節 (10.1), 第12節 (12.1) および `doc/architecture/sfvcs-design.md` の第171.4節の仕様を完全網羅し、カプセル化された Envelope Encryption Engine モジュールとして詳細を定義する。
