...
本書は `doc/specs/spec-algorithms.md` の第3節 (3.1, 3.2), 第4節 (4.1), 第15節 (15.1) および `doc/architecture/sfvcs-design.md` の第167.7節の仕様を完全網羅し、カプセル化された Diff Service モジュールとして具体的な処理フロー、変換ステップ、Rust/WASM アルゴリズム、および TypeScript インターフェースを定義する。
