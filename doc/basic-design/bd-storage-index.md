...
本書は `doc/specs/spec-storage.md` の第2節 (2.1), 第13節 (13.1), 第15節 (15.1) および `doc/architecture/sfvcs-design.md` の第171.9, 171.13, 171.14節の仕様を完全網羅し、カプセル化された Index Manager モジュールとして詳細を定義する。
