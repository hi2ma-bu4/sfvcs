...
本書は `doc/specs/spec-algorithms.md` の第2節 (2.1, 2.2), 第13節 (13.1), 第16節 (16.1) および `doc/architecture/sfvcs-design.md` の第167.1〜167.10, 171.14節を完全網羅し、カプセル化された Sequence Tree Builder モジュールとして定義する。
