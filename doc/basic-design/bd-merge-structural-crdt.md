...
本書は `doc/specs/spec-merge.md` の第7節 (7.1), 第8節 (8.1) および `doc/architecture/sfvcs-design.md` の第171.6, 171.8節の仕様を完全網羅し、カプセル化された Semantic & Realtime Merge Service モジュールとして詳細を定義する。
