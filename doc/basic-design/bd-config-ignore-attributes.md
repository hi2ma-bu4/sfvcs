...
本書は `doc/specs/spec-config-and-attributes.md` の全セクション（第1, 2, 3節）および `doc/architecture/sfvcs-design.md` の関連仕様を完全網羅し、カプセル化された Configuration & Pattern Evaluation Service モジュールとして詳細を定義する。
