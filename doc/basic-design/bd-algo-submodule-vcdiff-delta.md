...
本書は `doc/specs/spec-algorithms.md` の第12節 (12.1), 第14節 (14.1), 第17節 (17.1), 第20節 (20.1) および `doc/architecture/sfvcs-design.md` の第171.5, 171.10節の仕様を完全網羅し、カプセル化された Submodule & Pack Optimization Service モジュールとして詳細を定義する。
