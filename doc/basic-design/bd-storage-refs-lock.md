...
本書は `doc/specs/spec-storage.md` の第5節 (5.1, 5.2), 第7節 (7.1, 7.2, 7.3) および `doc/architecture/sfvcs-design.md` の第171.13, 171.14節の仕様を完全網羅し、カプセル化された Reference & Lock Management Service モジュールとして詳細を定義する。
