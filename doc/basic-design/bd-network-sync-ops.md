...
本書は `doc/specs/spec-network.md` の第4節 (4.1, 4.2, 4.3), 第5節, 第6節, 第7節, 第8節 (8.1), 第9節 (9.1) および `doc/architecture/sfvcs-design.md` の関連仕様を完全網羅し、カプセル化された Remote Synchronization Service モジュールとして詳細を定義する。
