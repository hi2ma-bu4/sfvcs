...
本書は `doc/specs/spec-merge.md` の第5節 (5.1, 5.2), 第6節 (6.1, 6.2, 6.3, 6.4), 第10節 (10.1) および `doc/architecture/sfvcs-design.md` の関連仕様を完全網羅し、カプセル化された Workflow Merge Service モジュールとして詳細を定義する。
