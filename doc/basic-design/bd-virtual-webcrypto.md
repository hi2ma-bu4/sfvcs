...
本書は `doc/specs/spec-virtual-vcs.md` の第3.3節, 第9節, 第12節、`doc/specs/spec-binary-format.md` の第5.2, 5.3節、および `doc/architecture/sfvcs-design.md` の第171.12節の仕様を完全網羅し、カプセル化された Cryptographic Authentication Service モジュールとして詳細を定義する。
