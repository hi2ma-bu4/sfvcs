...
本書は `doc/specs/spec-storage.md` の第9節 (9.1), 第14節 (14.1) および `doc/architecture/sfvcs-design.md` の第171.3節の仕様を完全網羅し、カプセル化された Binary Asset & Hook Service モジュールとして詳細を定義する。
